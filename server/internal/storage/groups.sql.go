...
SELECT id, name, status, monthly_limit, monthly_sent, allowed_ips, created_at, updated_at, group_type FROM groups WHERE status != 'deleted' ORDER BY created_at DESC
`
