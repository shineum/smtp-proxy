...
const countDeliveryLogsByAccount = `-- name: CountDeliveryLogsByAccount :many
...
type CountDeliveryLogsByAccountParams struct {
	CreatedAt   pgtype.Timestamptz `json:"created_at"`
	CreatedAt_2 pgtype.Timestamptz `json:"created_at_2"`
}

type CountDeliveryLogsByAccountRow struct {
	AccountID pgtype.UUID `json:"account_id"`
	Status    string      `json:"status"`
	Count     int64       `json:"count"`
}

func (q *Queries) CountDeliveryLogsByAccount(ctx context.Context, arg CountDeliveryLogsByAccountParams) ([]CountDeliveryLogsByAccountRow, error) {
	rows, err := q.db.Query(ctx, countDeliveryLogsByAccount, arg.CreatedAt, arg.CreatedAt_2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []CountDeliveryLogsByAccountRow
	for rows.Next() {
		var i CountDeliveryLogsByAccountRow
		if err := rows.Scan(&i.AccountID, &i.Status, &i.Count); err != nil {
			return nil, err
		}
		items = append(items, i)
	}
...
RETURNING id, message_id, provider_id, status, response_code, response_body, delivered_at, tenant_id, provider, provider_message_id, retry_count, last_error, metadata, created_at, updated_at, mt_tenant_id, account_id, duration_ms, attempt_number
`
...
SELECT id, message_id, provider_id, status, response_code, response_body, delivered_at, tenant_id, provider, provider_message_id, retry_count, last_error, metadata, created_at, updated_at, mt_tenant_id, account_id, duration_ms, attempt_number FROM delivery_logs WHERE message_id = $1
`
...
SELECT id, message_id, provider_id, status, response_code, response_body, delivered_at, tenant_id, provider, provider_message_id, retry_count, last_error, metadata, created_at, updated_at, mt_tenant_id, account_id, duration_ms, attempt_number FROM delivery_logs WHERE provider_message_id = $1
`
...
SELECT id, message_id, provider_id, status, response_code, response_body, delivered_at, tenant_id, provider, provider_message_id, retry_count, last_error, metadata, created_at, updated_at, mt_tenant_id, account_id, duration_ms, attempt_number FROM delivery_logs WHERE message_id = $1 ORDER BY delivered_at DESC
`
...
SELECT id, message_id, provider_id, status, response_code, response_body, delivered_at, tenant_id, provider, provider_message_id, retry_count, last_error, metadata, created_at, updated_at, mt_tenant_id, account_id, duration_ms, attempt_number FROM delivery_logs
