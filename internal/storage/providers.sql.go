...
VALUES ($1, $2, $3, $4, $5, $6)
RETURNING id, account_id, name, provider_type, api_key, smtp_config, enabled, created_at, updated_at
`
...
SELECT id, account_id, name, provider_type, api_key, smtp_config, enabled, created_at, updated_at FROM esp_providers WHERE id = $1
`
...
SELECT id, account_id, name, provider_type, api_key, smtp_config, enabled, created_at, updated_at FROM esp_providers WHERE account_id = $1 ORDER BY created_at DESC
`
